...
planning <- work %>%
  ...
  mutate(adjusted_start = as.Date(ifelse(planned_start_date < Sys.Date() - 30, Sys.Date() - 30, planned_start_date), origin = '1970-01-01'),
         ...
         ylab_staff = str_wrap(paste(project_activity, activity_name, sep = ": "), width = 50),
         ylab_project = str_wrap(paste0(project_activity,": ", activity_name, " (", activity_lead, ")"), width = 50)) 
